...
TEST_CASE("Black-Scholes call price: S=100,K=100,r=5%,sigma-20%,T=1") {
  ...
  // Known result ≈ 10.4506 (annualized vol/rate, no dividends, tolerance 1e-4 is fine for our math
  // impl) NOTE: We'll implement price_call next; for now this will fail, proving the test is live.
